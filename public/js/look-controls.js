 ...
 */
class LookControls {
    constructor(object3D, canvas) {
        //Properties:
        this._enabled = true;
        this._magicWindowTrackingEnabled = true;
        this._pointerLocked = false;
        this._reverseMouseDrag = false;
        this._reverseTouchDrag = false;
        ...
        this.magicWindowControls = new THREE.DeviceOrientationControls(this.magicWindowObject);
    ...
    get MagicWindowTrackingEnabled() { return this._magicWindowTrackingEnabled; }
    set MagicWindowTrackingEnabled(value) {
        // Reset magic window eulers if tracking is disabled.
        if (value === false) {
            this.magicWindowAbsoluteEuler.set(0, 0, 0);
            this.magicWindowDeltaEuler.set(0, 0, 0);
        }
        this._magicWindowTrackingEnabled = value;
    }

    get PointerLock() { return this._pointerLock; } //TODO: Chequea que esto este sincronizado con el estado del pointerLock.
    ...
    /**
      * Shows or Hides grabbing cursor on scene
    */
    showGrabbingCursor(value) {
     ...
     */
    onTouchMove(event) {
        if (!this.touchStarted || !this._touchEnabled) return;

        const deltaY = 2 * Math.PI * (event.touches[0].pageX - this.touchStart.x) / this.canvas.clientWidth;
